...
// Only use spaces, not tabs! Tabs are INCLUDED in the defines (fatal for Strings)!
...
#define DIALOG_BEAM                     opt_beamDialog
#define IDD_BEAM                        801
#define IDC_BEAM_MAP                    802
#define IDC_BEAM_LIST                   803
